        <header class="quiz-header">
            <div class="quiz-header-left">
                <h3><?= htmlspecialchars($kuis['nama_kuis'] ?? 'Kuis') ?></h3>
                <p><?= htmlspecialchars($kuis['nama_matkul'] ?? '') ?> · <?= (int)($kuis['jumlah_soal'] ?? 0) ?> soal</p>
            </div>
        ...
        <div class="quiz-layout">
            ...
            <div class="question-card fade-in">
                ...
                <div class="question-meta">
                    <span class="question-number">Soal 1 dari <?= count($soalList) ?></span>
                    <button class="btn-flag">Tandai</button>
                </div>
                <div class="question-body">
                    <p class="question-text"><?= htmlspecialchars($soal['pertanyaan'] ?? '') ?></p>
                    <div class="options-list">
                        ...
                        ?>
                            <div class="option-item">
                                <div class="option-letter"><?= $huruf[$i] ?></div>
            ...
            <div class="quiz-sidebar">
                <div class="quiz-panel">
                    ...
                    <div class="question-grid">
                        <?php foreach ($soalList as $i => $s): ?>
                            <div class="q-dot <?= $i === 0 ? 'current' : '' ?>"><?= $i + 1 ?></div>
                        <?php endforeach; ?>
                    </div>
                    <div class="grid-legend">
                        <div class="legend-item"><div class="legend-dot ld-current"></div> Sedang dikerjakan</div>
                        <div class="legend-item"><div class="legend-dot ld-answered"></div> Sudah dijawab</div>
                        <div class="legend-item"><div class="legend-dot ld-flagged"></div> Ditandai</div>
                        <div class="legend-item"><div class="legend-dot ld-unanswered"></div> Belum dijawab</div>
                    </div>
                </div>
                ...
                <div class="quiz-panel submit-section">
                    <div class="progress-summary">
                        <span>Terjawab</span>
                        <strong>0 / <?= count($soalList) ?></strong>
                    </div>
