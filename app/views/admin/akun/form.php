        ...
        <div class="form-card">
            ...
            <form method="POST" action="index.php?page=akun&action=<?= $action ?>">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control"
                            placeholder="Masukkan nama lengkap" value="<?= htmlspecialchars($akun['nama'] ?? '') ?>"
                            required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="contoh@email.com"
                            value="<?= htmlspecialchars($akun['email'] ?? '') ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="password">
                        Password
                        <?= $isEdit ? '<span class="text-muted">(kosongkan jika tidak ingin ubah)</span>' : '<span class="req">*</span>' ?>
                    </label>
