                    ...
                    <?php if (!empty($akuns)): ?>
                        ...
                        foreach ($akuns as $akun): ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge badge-<?= $akun['role'] === 'admin' ? 'blue' : ($akun['role'] === 'dosen' ? 'green' : 'orange') ?>">
                                        <?= ucfirst($akun['role']) ?>
                                    </span>
                                </td>
                                <td>
                                    <form method="POST" action="index.php?page=role&action=ubahRole"
                                        ...
                                        <select name="role_baru" class="form-control"
                                            style="padding:0.3rem 0.5rem; font-size:0.8rem;">
                                            <option value="mahasiswa" <?= $akun['role'] === 'mahasiswa' ? 'selected' : '' ?>>
                                                Mahasiswa</option>
