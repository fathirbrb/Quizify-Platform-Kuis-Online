...
<head>
    ...
    <meta name="description"
        content="Platform kuis online modern untuk perguruan tinggi. Buat kuis, kelola kelas, dan pantau nilai mahasiswa secara real-time." />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <link rel="stylesheet" href="public/css/style.css?v=<?= time() ?>" />
    <link rel="stylesheet" href="public/css/landing.css?v=<?= time() ?>" />
</head>
...
<body class="landing-body">
    ...
    <footer class="landing-footer" style="text-align: center; padding: 2rem;">
        <a href="#hero" class="footer-link" style="font-size: 0.9rem; font-weight: 600; color: var(--primary);">
            ↑ Kembali ke Atas (Back to the Top)
        </a>
    </footer>
